...
class IndependentSequenceLabelField(Field[torch.Tensor]):
    """
    ...
    def as_tensor(self,
        ...
        padded_tags = pad_sequence_to_length(self._indexed_labels, desired_num_tokens, default_value=lambda: -1)
    ...
    def empty_field(self):  # pylint: disable=no-self-use
        ...
        sequence_label_field = IndependentSequenceLabelField([])
