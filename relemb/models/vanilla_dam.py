...
@Model.register("dam_dropout")
class VanillaDam(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(VanillaDam, self).__init__(vocab, regularizer)
    ...
    def forward(self,  # type: ignore
        ...
        """
        embedded_premise = self._dropout(self._text_field_embedder(premise))
        embedded_hypothesis = self._dropout(self._text_field_embedder(hypothesis))
