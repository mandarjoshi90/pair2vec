...
@SpanExtractor.register("attentive_span_extractor")
class AttentiveSpanExtractor(SpanExtractor):
    """
    ...
    def forward(self,
        ...
        return attended_text_embeddings, span_attention_weights

    @classmethod
    def from_params(cls, params: Params) -> "SelfAttentiveSpanExtractor":
        input_dim = params.pop_int("input_dim")
        params.assert_empty(cls.__name__)
        return AttentiveSpanExtractor(input_dim=input_dim)
